...
SECRET_KEY = 'django-insecure-k3-6d26rc&1umn7&_2arwcy4tfs29n)+ccpnjv8_lrycr)@d9)'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'task2/templates/second_task', BASE_DIR / 'task2/templates/fourth_task'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
